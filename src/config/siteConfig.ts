...
export const siteConfig: SiteConfig = {
	...
	navbarTitle: "Wtada233's Blog", // 导航栏标题，可以设置为与 title 不同的值，如果不设置则使用 title
	...
	backgroundWallpaper: {
		...
		banner: {
			...
			credit: {
				...
				text: {
					desktop: "Firewatch", // 桌面端要显示的来源文本
					mobile: "Firewatch", // 移动端要显示的来源文本
				},
				url: {
					desktop: "https://store.steampowered.com/app/383870/Firewatch/", // 桌面端原始艺术品或艺术家页面的 URL 链接
					mobile: "https://store.steampowered.com/app/383870/Firewatch/", // 移动端原始艺术品或艺术家页面的 URL 链接
				},
			},
			navbar: {

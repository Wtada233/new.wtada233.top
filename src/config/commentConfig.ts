...
export const commentConfig: CommentConfig = {
	...
	//giscus评论系统配置（还未测试）
	giscus: {
		repo: "Wtada233/fuwari-comments-wtada233.top", // 设置 Giscus 评论系统仓库
		repoId: "R_kgDOQcCOWQ", // 设置 Giscus 评论系统仓库ID
		category: "Announcements", // 设置 Giscus 评论系统分类
		categoryId: "DIC_kwDOQcCOWc4Cy2tE", // 设置 Giscus 评论系统分类ID
